...
totparl = 2*parl
parlgamma = (parl-nEV)
namescoef =  c("beta_{T,0}","beta_{T,1}","alpha_{T,1}","alpha_{T,2}","lambda_{T,1}","lambda_{T,2}","beta_{C,0}","beta_{C,1}","alpha_{C,1}","alpha_{C,2}","lambda_{C,1}","lambda_{C,2}","sigma_T","sigma_C","rho","theta_1","theta_2")
