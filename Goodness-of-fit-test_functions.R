...
# This function is exactly the same as GOF_test, except this one uses parallel
# computing when doing the bootstrap procedure.
...
# This function computes the goodness-of-fit based on the limiting distribution
# of the Cramer - von Mises criterion (omega-squared distribution).
